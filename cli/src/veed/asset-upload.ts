...
// twice, slightly differently: fabric.ts's resolveImageAsset (scoped, IMAGE) and orchestrate.ts's
// transcribeWithVeed (unscoped, VIDEO). Neither is refactored onto this — both already work — but a third local-file upload (video
