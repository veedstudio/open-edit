...
//
//   default   the live VEED route (POST /v1/remove-background) — free, no credits are deducted,
//             authorized by a project's CAN_WRITE permission.
//   --fast    the public fal model veed/video-background-removal/fast, reached the same way every other
//             generated asset in this repo reaches fal — the user's own key (cli/src/providers/fal.ts).
