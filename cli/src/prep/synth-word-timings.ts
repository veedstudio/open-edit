...
// spoken window best.
//
// Importable (the prep command calls synthWordTimings); the standalone fallback CLI
// (e.g. when the inline creative pass drops/merges the displayed words of a beat) is
// the synth-timings command, which wraps evenSplitDelays.
