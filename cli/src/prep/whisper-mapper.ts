...
// the VEED provider writes, so downstream (prep, extract-beat-frames, synth-word-timings)
...
import type { Transcript, TranscriptChunk, TranscriptWord } from './transcript-types.ts';
